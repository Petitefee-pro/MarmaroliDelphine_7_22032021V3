        ...
        <div class="border border-white rounded">
            <form id="forum" @submit.prevent="submitFormCommentaire" class="row justify-content-center was-validated needs-validation" novalidate>
                <div class="form-group col-11 col-md-10 m-0 p-1">
                    ...
                    <textarea name="post" id="post" class="form-control form-control-lg" placeholder="Veuillez saisir un commentaire" v-model="post" pattern="[A-Za-z\s\-éöàäèüáúóêûîôâ']{2,1500}" required></textarea>
                    <div class="valid-feedback">Valide</div>
                    <div class="invalid-feedback"></div>
                </div>
                <div class="form-group col-6 col-md-7 col-lg-9 col-xl-11 mb-2 text-center">
                    <button type="submit" @click.prevent="submitFormCommentaire" class="btn btn-primary btn-lg col-12 col-md-5 mt-3 mb-2">Poster</button>
                </div>            
            </form>
        </div>
    </div>
